...
public class DefaultTrackSelector extends MappingTrackSelector {
    ...
    private static void log(String msg) {
        Log.i("DefaultTrackSelector", msg);
    }
    ...
    public static final class ParametersBuilder extends TrackSelectionParameters.Builder {
        ...
        public final ParametersBuilder clearSelectionOverride(int rendererIndex, TrackGroupArray groups) {
            Map<TrackGroupArray, @NullableType SelectionOverride> overrides = selectionOverrides.get(rendererIndex);
        ...
        private static SparseArray<Map<TrackGroupArray, @NullableType SelectionOverride>> cloneSelectionOverrides(
            SparseArray<Map<TrackGroupArray, @NullableType SelectionOverride>> selectionOverrides) {
            SparseArray<Map<TrackGroupArray, @NullableType SelectionOverride>> clone = new SparseArray<>();
    ...
    public static final class Parameters extends TrackSelectionParameters implements Parcelable {
        ...
        private static SparseArray<Map<TrackGroupArray, @NullableType SelectionOverride>> readSelectionOverrides(
            Parcel in) {
            ...
            for (int i = 0; i < renderersWithOverridesCount; i++) {
                ...
                Map<TrackGroupArray, @NullableType SelectionOverride> overrides = new HashMap<>(overrideCount);
        ...
        private static void writeSelectionOverridesToParcel(
            ...
            for (int i = 0; i < renderersWithOverridesCount; i++) {
                ...
                Map<TrackGroupArray, @NullableType SelectionOverride> overrides = selectionOverrides.valueAt(i);
                int overrideCount = overrides.size();
                dest.writeInt(rendererIndex);
                dest.writeInt(overrideCount);
                for (Map.Entry<TrackGroupArray, @NullableType SelectionOverride> override : overrides.entrySet()) {
        ...
        private static boolean areSelectionOverridesEqual(
            ...
            for (Map.Entry<TrackGroupArray, @NullableType SelectionOverride> firstEntry : first.entrySet()) {
    ...
    public static final class SelectionOverride implements Parcelable {
        ...
        public boolean equals(@Nullable Object obj) {
            ...
            return groupIndex == other.groupIndex && Arrays.equals(tracks, other.tracks) && type == other.type;
        }
    ...
    private static final Ordering<Integer> FORMAT_VALUE_ORDERING =
        Ordering.from(
            (first, second) -> first == Format.NO_VALUE
    ...
    protected ExoTrackSelection.@NullableType Definition[] selectAllTracks(
        ...
        for (int i = 0; i < rendererCount; i++) {
            ...
            switch (trackType) {
                ...
                default:
                    definitions[i] =
                        selectOtherTrack(trackType, mappedTrackInfo.getTrackGroups(i), rendererFormatSupports[i],
                            params);
                    break;
            }
        }
