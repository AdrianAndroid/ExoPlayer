...
public final class TextRenderer extends BaseRenderer implements Callback {
    ...
    public TextRenderer(TextOutput output, @Nullable Looper outputLooper, SubtitleDecoderFactory decoderFactory) {
        ...
        this.outputHandler = outputLooper == null ? null : Util.createHandler(outputLooper, /* callback= */ this);
    ...
    public int supportsFormat(Format format) {
        if (decoderFactory.supportsFormat(format)) {
            return RendererCapabilities
                .create(format.exoMediaCryptoType == null ? C.FORMAT_HANDLED : C.FORMAT_UNSUPPORTED_DRM);
