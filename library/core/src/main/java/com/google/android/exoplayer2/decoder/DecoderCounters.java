...
/**
 * Maintains decoder event counts, for debugging purposes only. 维护解码器事件计数，仅用于调试目的。
 *
...
public final class DecoderCounters {
    ...
    public void merge(DecoderCounters other) {
        ...
        maxConsecutiveDroppedBufferCount = max(maxConsecutiveDroppedBufferCount, other.maxConsecutiveDroppedBufferCount);
