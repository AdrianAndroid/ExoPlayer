...
public abstract class MappingTrackSelector extends TrackSelector {
    ...
    public static final class MappedTrackInfo {
        ...
        public int getTrackSupport(int rendererIndex, int groupIndex, int trackIndex) {
            return RendererCapabilities.getFormatSupport(rendererFormatSupports[rendererIndex][groupIndex][trackIndex]);
        }
     ...
     */
    protected abstract Pair<@NullableType RendererConfiguration[], @NullableType ExoTrackSelection[]> selectTracks(
        MappedTrackInfo mappedTrackInfo,
        @Capabilities int[][][] rendererFormatSupports,
     ...
     */
    @AdaptiveSupport
    private static int[] getMixedMimeTypeAdaptationSupports(RendererCapabilities[] rendererCapabilities)
        throws ExoPlaybackException {
