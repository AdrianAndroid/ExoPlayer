...
public class SimpleExoPlayer extends BasePlayer
    ...
    protected SimpleExoPlayer(Builder builder) {
        ...
        try {
            ...
            renderers = builder.renderersFactory.createRenderers(
                eventHandler,
                componentListener,
                componentListener,
                componentListener,
            ...
            audioBecomingNoisyManager = new AudioBecomingNoisyManager(builder.context, eventHandler, componentListener);
            ...
            sendRendererMessage(C.TRACK_TYPE_VIDEO, MSG_SET_VIDEO_FRAME_METADATA_LISTENER, frameMetadataListener);
            sendRendererMessage(C.TRACK_TYPE_CAMERA_MOTION, MSG_SET_CAMERA_MOTION_LISTENER, frameMetadataListener);
        } finally {
    ...
    public void setVideoSurfaceHolder(@Nullable SurfaceHolder surfaceHolder) {
        ...
        if (surfaceHolder == null) {
            ...
            removeSurfaceCallbacks(); // 先移除所有的callback回调
    ...
    public void prepare() {
        ...
        updatePlayWhenReady(playWhenReady, playerCommand, getPlayWhenReadyChangeReason(playWhenReady, playerCommand));
        player.prepare();
    }
    ...
    private final class ComponentListener
        ...
        TextureView.SurfaceTextureListener, // SurfaceView自带的一个回调
