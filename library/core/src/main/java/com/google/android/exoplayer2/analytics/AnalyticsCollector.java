...
public class AnalyticsCollector
     ...
     */
    public final void updateMediaPeriodQueueInfo(List<MediaPeriodId> queue, @Nullable MediaPeriodId readingPeriod) {
    ...
    @SuppressWarnings("deprecation") // Calling deprecated listener method.
    @Override
    public final void onAudioDecoderInitialized(String decoderName, long initializedTimestampMs,
     ...
     */
    protected final void sendEvent(EventTime eventTime, int eventFlag,
    ...
    private static final class MediaPeriodQueueTracker {
        ...
        @Nullable
        private MediaPeriodId currentPlayerMediaPeriod;
