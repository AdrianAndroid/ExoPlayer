...
public final class DashMediaSource extends BaseMediaSource {
    ...
    public static final class Factory implements MediaSourceFactory {
        ...
        public Factory(DashChunkSource.Factory chunkSourceFactory,
            ...
            log("Factory(DashChunkSource.Factory chunkSourceFactory, @Nullable DataSource.Factory manifestDataSourceFactory)");
        ...
        public Factory setTag(@Nullable Object tag) {
            log("public Factory setTag(@Nullable Object tag)");
            this.tag = tag;
            return this;
        }
        ...
        public Factory setStreamKeys(@Nullable List<StreamKey> streamKeys) {
            log("public Factory setStreamKeys(@Nullable List<StreamKey> streamKeys)");
        ...
        public Factory setDrmSessionManagerProvider(@Nullable DrmSessionManagerProvider drmSessionManagerProvider) {
            log("public Factory setDrmSessionManagerProvider(@Nullable DrmSessionManagerProvider drmSessionManagerProvider)");
        ...
        public Factory setDrmSessionManager(@Nullable DrmSessionManager drmSessionManager) {
            log("public Factory setDrmSessionManager(@Nullable DrmSessionManager drmSessionManager)");
        ...
        public Factory setDrmHttpDataSourceFactory(@Nullable HttpDataSource.Factory drmHttpDataSourceFactory) {
            log("public Factory setDrmHttpDataSourceFactory(@Nullable HttpDataSource.Factory drmHttpDataSourceFactory)");
        ...
        public Factory setDrmUserAgent(@Nullable String userAgent) {
            log("public Factory setDrmUserAgent(@Nullable String userAgent)");
            if (!usingCustomDrmSessionManagerProvider) {
        ...
        public Factory setLoadErrorHandlingPolicy(@Nullable LoadErrorHandlingPolicy loadErrorHandlingPolicy) {
            log("public Factory setLoadErrorHandlingPolicy(@Nullable LoadErrorHandlingPolicy loadErrorHandlingPolicy)");
        ...
        public Factory setLivePresentationDelayMs(long livePresentationDelayMs, boolean overridesManifest) {
            log("public Factory setLivePresentationDelayMs(long livePresentationDelayMs, boolean overridesManifest)");
        ...
        public Factory setFallbackTargetLiveOffsetMs(long fallbackTargetLiveOffsetMs) {
            log("public Factory setFallbackTargetLiveOffsetMs(long fallbackTargetLiveOffsetMs)");
        ...
        public Factory setManifestParser(@Nullable ParsingLoadable.Parser<? extends DashManifest> manifestParser) {
            log("public Factory setManifestParser(@Nullable ParsingLoadable.Parser<? extends DashManifest> manifestParser)");
        ...
        public Factory setCompositeSequenceableLoaderFactory(
            ...
            log("public Factory setCompositeSequenceableLoaderFactory(@Nullable CompositeSequenceableLoaderFactory compositeSequenceableLoaderFactory)");
        ...
        public DashMediaSource createMediaSource(DashManifest manifest) {
            log("public DashMediaSource createMediaSource(DashManifest manifest)");
        ...
        public DashMediaSource createMediaSource(DashManifest manifest, MediaItem mediaItem) {
            log("public DashMediaSource createMediaSource(DashManifest manifest, MediaItem mediaItem)");
        ...
        public DashMediaSource createMediaSource(MediaItem mediaItem) {
            log("public DashMediaSource createMediaSource(MediaItem mediaItem)");
            checkNotNull(mediaItem.playbackProperties);
            @Nullable ParsingLoadable.Parser<? extends DashManifest> manifestParser = this.manifestParser;
            if (manifestParser == null) {
                manifestParser = new DashManifestParser();
            }
            List<StreamKey> streamKeys = mediaItem.playbackProperties.streamKeys.isEmpty()
            ...
            boolean needsStreamKeys = mediaItem.playbackProperties.streamKeys.isEmpty() && !streamKeys.isEmpty();
            boolean needsTargetLiveOffset = mediaItem.liveConfiguration.targetOffsetMs == C.TIME_UNSET
                && targetLiveOffsetOverrideMs != C.TIME_UNSET;
    ...
    public void replaceManifestUri(Uri manifestUri) {
        log("public void replaceManifestUri(Uri manifestUri)");
    ...
    public MediaItem getMediaItem() {
        log("public MediaItem getMediaItem()");
        return mediaItem;
    }

    @Override
    protected void prepareSourceInternal(@Nullable TransferListener mediaTransferListener) {
        log("void prepareSourceInternal(@Nullable TransferListener mediaTransferListener) ");
    ...
    public void maybeThrowSourceInfoRefreshError() throws IOException {
        log("oid maybeThrowSourceInfoRefreshError()");
        manifestLoadErrorThrower.maybeThrowError();
    }

    @Override
    public MediaPeriod createPeriod(MediaPeriodId id, Allocator allocator, long startPositionUs) {
        log("MediaPeriod createPeriod(MediaPeriodId id, Allocator allocator, long startPositionUs)");
    ...
    public void releasePeriod(MediaPeriod mediaPeriod) {
        log("void releasePeriod(MediaPeriod mediaPeriod)");
    ...
    protected void releaseSourceInternal() {
        log("void releaseSourceInternal()");
    ...
    /* package */ void onDashManifestRefreshRequested() {
        log("void onDashManifestRefreshRequested() ");
        handler.removeCallbacks(simulateManifestRefreshRunnable);
        startLoadingManifest();
    }

    /* package */ void onDashManifestPublishTimeExpired(long expiredManifestPublishTimeUs) {
        log("void onDashManifestPublishTimeExpired(long expiredManifestPublishTimeUs)");
    ...
    /* package */ void onManifestLoadCompleted(ParsingLoadable<DashManifest> loadable, long elapsedRealtimeMs,
                                               long loadDurationMs) {
        log("void onManifestLoadCompleted(ParsingLoadable<DashManifest> loadable, long elapsedRealtimeMs, long loadDurationMs)");
    ...
    /* package */ LoadErrorAction onManifestLoadError(
        ...
        log("LoadErrorAction onManifestLoadError");
    ...
    /* package */ void onUtcTimestampLoadCompleted(ParsingLoadable<Long> loadable, long elapsedRealtimeMs,
                                                   long loadDurationMs) {
        log("void onUtcTimestampLoadCompleted(ParsingLoadable<Long> loadable, long elapsedRealtimeMs, long loadDurationMs)");
        LoadEventInfo loadEventInfo =
            new LoadEventInfo(
                loadable.loadTaskId,
                loadable.dataSpec,
    ...
    /* package */ LoadErrorAction onUtcTimestampLoadError(
        ...
        log("LoadErrorAction onUtcTimestampLoadError");
    ...
    /* package */ void onLoadCanceled(ParsingLoadable<?> loadable, long elapsedRealtimeMs, long loadDurationMs) {
        log("onLoadCanceled(ParsingLoadable<?> loadable, long elapsedRealtimeMs, long loadDurationMs)");
        LoadEventInfo loadEventInfo =
            new LoadEventInfo(
                loadable.loadTaskId,
                loadable.dataSpec,
    ...
    private void resolveUtcTimingElement(UtcTimingElement timingElement) {
        log("void resolveUtcTimingElement(UtcTimingElement timingElement)");
    ...
    private void resolveUtcTimingElementDirect(UtcTimingElement timingElement) {
        log("void resolveUtcTimingElementDirect(UtcTimingElement timingElement)");
        try {
    ...
    private void resolveUtcTimingElementHttp(UtcTimingElement timingElement, ParsingLoadable.Parser<Long> parser) {
        log("resolveUtcTimingElementHttp(UtcTimingElement timingElement, ParsingLoadable.Parser<Long> parser)");
        startLoading(
            new ParsingLoadable<>(
    ...
    private void onUtcTimestampResolved(long elapsedRealtimeOffsetMs) {
        log("void onUtcTimestampResolved(long elapsedRealtimeOffsetMs)");
    ...
    private void onUtcTimestampResolutionError(IOException error) {
        ...
        log("onUtcTimestampResolutionError(IOException error)");
        // Be optimistic and continue in the hope that the device clock is correct.
        processManifest(true);
    }

    private void processManifest(boolean scheduleRefresh) {
        log("void processManifest(boolean scheduleRefresh) ");
        // Update any periods.
        ...
        long windowStartTimeInManifestUs =
            getAvailableStartTimeInManifestUs(firstPeriod, manifest.getPeriodDurationUs(0), nowUnixTimeUs);
        ...
        if (manifest.dynamic) {
            ...
            windowStartUnixTimeMs = manifest.availabilityStartTimeMs + C.usToMs(windowStartTimeInManifestUs);
    ...
    private void updateMediaItemLiveConfiguration(long nowInWindowUs, long windowDurationUs) {
        log("updateMediaItemLiveConfiguration(long nowInWindowUs, long windowDurationUs)");
        long maxLiveOffsetMs;
        if (mediaItem.liveConfiguration.maxOffsetMs != C.TIME_UNSET) {
            maxLiveOffsetMs = mediaItem.liveConfiguration.maxOffsetMs;
        } else if (manifest.serviceDescription != null && manifest.serviceDescription.maxOffsetMs != C.TIME_UNSET) {
        ...
        } else if (manifest.serviceDescription != null && manifest.serviceDescription.targetOffsetMs != C.TIME_UNSET) {
        ...
        if (targetOffsetMs > maxLiveOffsetMs) {
            long safeDistanceFromWindowStartUs = min(MIN_LIVE_DEFAULT_START_POSITION_US, windowDurationUs / 2);
            long maxTargetOffsetForSafeDistanceToWindowStartMs =
                C.usToMs(nowInWindowUs - safeDistanceFromWindowStartUs);
            targetOffsetMs =
                Util.constrainValue(maxTargetOffsetForSafeDistanceToWindowStartMs, minLiveOffsetMs, maxLiveOffsetMs);
        }
        ...
        liveConfiguration = new MediaItem.LiveConfiguration(
    ...
    private void scheduleManifestRefresh(long delayUntilNextLoadMs) {
        log("void scheduleManifestRefresh(long delayUntilNextLoadMs)");
        handler.postDelayed(refreshManifestRunnable, delayUntilNextLoadMs);
    }

    private void startLoadingManifest() {
        log("void startLoadingManifest()");
    ...
    private long getManifestLoadRetryDelayMillis() {
        log("long getManifestLoadRetryDelayMillis()");
        return min((staleManifestReloadAttempt - 1) * 1000, 5000);
    }

    private <T> void startLoading(ParsingLoadable<T> loadable, Loader.Callback<ParsingLoadable<T>> callback,
                                  int minRetryCount) {
        log("startLoading(ParsingLoadable<T> loadable");
        long elapsedRealtimeMs = loader.startLoading(loadable, callback, minRetryCount);
        manifestEventDispatcher
            .loadStarted(new LoadEventInfo(loadable.loadTaskId, loadable.dataSpec, elapsedRealtimeMs), loadable.type);
    }

    private static long getIntervalUntilNextManifestRefreshMs(DashManifest manifest, long nowUnixTimeMs) {
        log("static long getIntervalUntilNextManifestRefreshM");
    ...
    private static long getAvailableStartTimeInManifestUs(Period period, long periodDurationUs, long nowUnixTimeUs) {
        ...
        log("getAvailableStartTimeInManifestUs(Period period, long periodDurationUs, long nowUnixTimeUs)");
    ...
    private static long getAvailableEndTimeInManifestUs(Period period, long periodDurationUs, long nowUnixTimeUs) {
        ...
        log("getAvailableEndTimeInManifestUs(Period period, long periodDurationUs, long nowUnixTimeUs)");
        ...
        for (int i = 0; i < period.adaptationSets.size(); i++) {
            ...
            long adaptationSetAvailableEndTimeInManifestUs = periodStartTimeInManifestUs
    ...
    private static boolean isIndexExplicit(Period period) {
        log("isIndexExplicit(Period period)");
        for (int i = 0; i < period.adaptationSets.size(); i++) {
            @Nullable
    ...
    private static boolean hasVideoOrAudioAdaptationSets(Period period) {
        log("hasVideoOrAudioAdaptationSets(Period period)");
        for (int i = 0; i < period.adaptationSets.size(); i++) {
    ...
    private static final class DashTimeline extends Timeline {
        ...
        public Period getPeriod(int periodIndex, Period period, boolean setIds) {
            log("public Period getPeriod(int periodIndex, Period period, boolean setIds)");
        ...
        public int getIndexOfPeriod(Object uid) {
            log("int getIndexOfPeriod(Object uid)");
        ...
        private long getAdjustedWindowDefaultStartPositionUs(long defaultPositionProjectionUs) {
            log("long getAdjustedWindowDefaultStartPositionUs(long defaultPositionProjectionUs)");
        ...
        public Object getUidOfPeriod(int periodIndex) {
            log("public Object getUidOfPeriod(int periodIndex)");
            Assertions.checkIndex(periodIndex, 0, getPeriodCount());
            return firstPeriodId + periodIndex;
        }

        private static boolean isMovingLiveWindow(DashManifest manifest) {
            log("private static boolean isMovingLiveWindow(DashManifest manifest)");
    ...
    private final class DefaultPlayerEmsgCallback implements PlayerEmsgCallback {
        ...
        public void onDashManifestRefreshRequested() {
            log("public void onDashManifestRefreshRequested()");
    ...
    private final class ManifestCallback implements Loader.Callback<ParsingLoadable<DashManifest>> {
        ...
        public void onLoadCompleted(ParsingLoadable<DashManifest> loadable, long elapsedRealtimeMs,
                                    long loadDurationMs) {
            log("onLoadCompleted(ParsingLoadable<DashManifest> loadable, long elapsedRealtimeMs,");
        ...
        public LoadErrorAction onLoadError(
            ...
            IOException error,
            int errorCount) {
            log("public LoadErrorAction onLoadError");
    ...
    private final class UtcTimestampCallback implements Loader.Callback<ParsingLoadable<Long>> {
        ...
        public void onLoadCompleted(ParsingLoadable<Long> loadable, long elapsedRealtimeMs, long loadDurationMs) {
            log("onLoadCompleted(ParsingLoadable<Long> loadable, long elapsedRealtimeMs, long loadDurationMs)");
            onUtcTimestampLoadCompleted(loadable, elapsedRealtimeMs, loadDurationMs);
        }

        @Override
        public void onLoadCanceled(ParsingLoadable<Long> loadable, long elapsedRealtimeMs, long loadDurationMs,
                                   boolean released) {
            log("onLoadCanceled(ParsingLoadable<Long> loadable, long elapsedRealtimeMs, long loadDurationMs,");
            DashMediaSource.this.onLoadCanceled(loadable, elapsedRealtimeMs, loadDurationMs);
        }

        @Override
        public LoadErrorAction onLoadError(ParsingLoadable<Long> loadable, long elapsedRealtimeMs, long loadDurationMs,
                                           IOException error, int errorCount) {
            log("LoadErrorAction onLoadError(ParsingLoadable<Long> loadable, long elapsedRealtimeMs, long loadDurationMs");
